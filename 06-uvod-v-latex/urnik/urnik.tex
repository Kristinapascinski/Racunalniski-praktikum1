...
\begin{itemize}
   ...
   \item Za vse proste termine ?? izračunamo ceno vstavljanja ??, ki ga sestavlja ??, profesor, ki ta predmet predava,
...
\noindent \textit{Sistem okolic} je množica vseh možnih sprememb, ki jih lahko z vsemi operacijami iz
